...
--/UNSUPPORTED/assert(string.char(0, string.byte("�"), 0) == "\0�\0")
...
--/UNSUPPORTED/assert(string.format('%q', "\0") == [["\000"]])
--/UNSUPPORTED/assert(string.format("\0%c\0%c%x\0", string.byte("�"), string.byte("b"), 140) == "\0�\0b8c\0")
...
if not trylocale("collate")  then
  ...
  --/UNSUPPORTED/assert("alo" < "�lo" and "�lo" < "amo")
end

if not trylocale("ctype") then
  print("locale not supported")
else
  --/UNSUPPORTED/assert(string.gsub("�����", "%a", "x") == "xxxxx")
  --/UNSUPPORTED/assert(string.gsub("����", "%l", "x") == "x�x�")
  --/UNSUPPORTED/assert(string.gsub("����", "%u", "x") == "�x�x")
  --/UNSUPPORTED/assert(string.upper"���{xuxu}��o" == "���{XUXU}��O")
end
