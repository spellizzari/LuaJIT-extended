...
assert(f('�', '�?') == '�')
assert(f('�bl', '�?b?l?') == '�bl')
--/UNSUPPORTED/assert(f('  �bl', '�?b?l?') == '')
assert(f('aa', '^aa?a?a') == 'aa')
--/UNSUPPORTED/assert(f(']]]�b', '[^]]') == '�')
...
--/UNSUPPORTED/assert(a == '�lo alo' and b == '�l' and c == '�' and d == 'alo' and e == nil)
...
t = "ab� d"
a, b = string.gsub(t, '(.)', '%1@')
--/UNSUPPORTED/assert('@'..a == string.gsub(t, '', '@') and b == 5)
...
-- tests for gmatch
--/UNSUPPORTED/assert(string.gfind == string.gmatch)
local a = 0
