...
--
-- redefine tmpname to return file names without dots
--
local tmpnameIncrement = 1
os.tmpname = function()
  local path = os.getenv('TEMP') .. '\\' .. os.date('%H%M%S') .. tmpnameIncrement
  tmpnameIncrement = tmpnameIncrement + 1
  print(path)
  return path
end
